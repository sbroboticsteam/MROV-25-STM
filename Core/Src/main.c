...
void Start_I2C_Telemetry(void *argument);
...
int main(void)
{
  ...
  I2C_TelemetryHandle = osThreadNew(Start_I2C_Telemetry, NULL, &I2C_Telemetry_attributes);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_7, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PD1 PD2 PD7 */
...
/* USER CODE BEGIN Header_Start_I2C_Telemetry */
/**
* @brief Function implementing the I2C_Telemetry thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_Start_I2C_Telemetry */
void Start_I2C_Telemetry(void *argument)
{
